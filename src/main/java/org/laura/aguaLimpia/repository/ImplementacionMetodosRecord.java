...
public class ImplementacionMetodosRecord implements MetodosRecord {
    @Override
    public ArrayList<DatosMunicipioAguaEscasa> datosMunicipioAguaEscasa() {
        ...
        data[2] = new DatosMunicipioAguaEscasa("Lorica", 115461, 6, 9, 12);
        ...
        List<DatosMunicipioAguaEscasa> listaMunicipiosAguaEscasa = new ArrayList<>(Arrays.asList(data));

        return (ArrayList<DatosMunicipioAguaEscasa>) listaMunicipiosAguaEscasa;
    }
}
